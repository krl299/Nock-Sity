...
public class RoadManager : MonoBehaviour
{
    ...
    public void PlaceRoad(Vector3Int position)
    {
        ...
        if (placementMode == false)
        {
            ...
            placementManager.PlaceTemporaryStructure(position, roadFixer.roadDeadEnd, CellType.Road);
        ...
        else
        {
            ...
            foreach (var temporaryPosition in temporaryPlacementPositions)
            {
                ...
                placementManager.PlaceTemporaryStructure(temporaryPosition, roadFixer.roadDeadEnd, CellType.Road);
            }
        }
